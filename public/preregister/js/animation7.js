...
window.onload = function() {
    ...
    var pathOptions = [{color: '#FF5555',opacity: 1,angle: -50, position: 'TL',x: -400,y: -600,scale: 1},
                        {color: '#B72A43',opacity: 0.5,angle: 0, position: 'BR',x: 100,y: 270,scale: 1.3},
                        {color: '#FF8A7F',opacity: 0.47,angle: 0, position: 'BR',x: 400,y: 280,scale: 1.3},
                        {color: '#FF8A7F',opacity: 0.61,angle: 180, position: 'TR',x: 300,y: -55,scale: 1}];
