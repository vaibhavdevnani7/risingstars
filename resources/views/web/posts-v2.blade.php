  ...
  <div class="postSection">
              <div class="banner_Section">
                <div class='description'>
                       <h2>RISING STARS</h2>
                       <h3>World’s Leading Place To <br> Discover Crypto &<br> Web3 Projects.</h3>
                           ...
                           <ul>
                             ...
                             <li>
                               <a href="https://discord.gg/Msh4BeYhDj" target="_blank">
                                 <i class="fab fa-discord"></i> {{-- <span class="discord-text">Join our Discord</span> --}}
                               </a>
                             </li>
                           </ul>
                         </div>
              ...
              <div class="listCollumn">
                <div class="container">
                  <div class="row">
                    <div class="col-md-8 lazy-loader">
                    ...
                    <div class="col-md-4 pl-5 blog-section" style="border-left: solid #ccc 1px;">
                      <div class="titleSection">
                        <!-- <h6>Featured</h6> -->
                        <h2>Featured Blogposts</h2>
                      </div>
                      <!---blogPost--->
                      <a target="_blank" href="https://risingcapital.substack.com/p/20-charts-and-tweets-that-describe" class="blogPost">
    ...
    <div style="" class="blog-img-sec">
                                    <img class="w-100" src="https://cdn.substack.com/image/fetch/w_900,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2Fc590b444-f56d-4dc2-90d5-ee8eb73e3340_886x886.jpeg"></div>
                                  </div>
                                  <div class="col-md-8 pl-1 pt-1">
                                    <h4>20 Charts & Tweets that Describe</h4>
                                    <h6>8 min read</h6>
                                    <p>Crypto had a smashing 2021, yet again...</p>
                                  </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card-body">
                            <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-4 pl-0">
                                    <div style="" class="blog-img-sec">
                                      <img class="w-100" src="https://cdn.substack.com/image/fetch/w_336,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F0c97bb61-89df-474b-87af-24ab87155a36_1000x576.png">
                                    </div>
                                  </div>
                                  <div class="col-md-8 pl-1 pt-1">
                                    <h4>What does the Indian crypto bill..</h4>
                                    <h6>9 min read</h6>
                                    <p>The finance world in the last decade has  ..</p>
                                  </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card-body">
                            <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-4 pl-0">
    <div style="" class="blog-img-sec">
                                    <img class="w-100" src="https://cdn.substack.com/image/fetch/w_336,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F2f74e39b-844c-432a-9938-d65650bcc34f_836x499.jpeg"></div>
                                  </div>
                                  <div class="col-md-8 pl-1 pt-1">
                                    <h4>JackOn</h4>
                                    <h6>8 min read</h6>
                                    <p>Why Jack & Elon are so wrong about ..</p>
                                  </div>
                                </div>
                            </div>
                          </div>
                      ...
                      <div class="web-3-section">
                        <a href="https://sand-challenge-855.notion.site/Rising-Stars-Guide-48f085cde58342cbb02792e8ca56fefb" target="_blank"><div class="p-2 m-4 web-3" style="
                            ">Get Started With Web3 <img src="{{asset('assets/img/notion.png')}}"></div></a>
                      </div>
                      <div class="web-3-section">
                        <iframe src="https://hashtalk.substack.com/embed" width="480" height="180" style="background:white; border-radius: 4px;" frameborder="0" scrolling="no"></iframe>
                      </div>
                      ...
                      <div class="text-center mt-8 pt-5 timeline">
                        ...
                        <div class=""> @ {{date('Y');}} <a class="__dev" href="{{url('/')}}"  rel="noopener noreferrer">risingstars.co</a></div>
                      </div>
                    </div>
                  </div>
                </div>
